				...
				<tbody>
					<tr data-module-name="Calendar">
						...
						<td class="row-fluid">
                            ...
                            <div><input type="radio" value="0" data-action-state="Public: Read Only" name="permissions[9]" style="margin-left: 25%"></div>
						</td>
						<td class="row-fluid">
							<div><input type="radio" style="margin-left: 25%" disabled="disabled" /></div>
						</td>
						...
						<td class="triggerCustomSharingAccess">
							<div class="row-fluid">
								...
								<div class="span6">
                                    ...
                                    <button type="button" class="btn btn-mini vtButton arrowDown row-fluid" data-handlerfor="fields" data-togglehandler="9-rules"><img src="layouts/vlayout/skins/images/Arrow-down.png"></img></button>
									<button type="button" class="btn btn-mini vtButton arrowUp row-fluid hide" data-handlerfor="fields" data-togglehandler="9-rules"><img src="layouts/vlayout/skins/images/Arrow-up.png"></img></button>
								</div>
								<div class="span3">&nbsp;</div>
							</div>
						</td>
