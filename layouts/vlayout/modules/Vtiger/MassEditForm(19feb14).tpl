					...
					<div class="tab-pane {if $smarty.foreach.blockIterator.iteration eq 1}active{/if}" id="block_{$smarty.foreach.blockIterator.iteration}">
						<table class="massEditTable table table-bordered">
							...
							{if $COUNTER is odd}                            							
                                <td>
                                {if $MODULE eq 'Leads'}	
                                Activity Start Date &nbsp;&nbsp;&nbsp;<input type="text"  data-validation-engine="validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" value="" readonly="readonly" data-date-format="dd-mm-yyyy" name="leadactivitystartdate" class="span9 dateField" style="width:190px;" id="leadactivitystartdate" >
