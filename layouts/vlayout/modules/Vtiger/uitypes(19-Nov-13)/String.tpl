...
{if $MODULE eq 'Campaigns' && ($FIELD_MODEL->get("name") eq "location" || $FIELD_MODEL->get("name") eq "targetaudience" || $FIELD_MODEL->get("name") eq "sponsor" || $FIELD_MODEL->get("name") eq "leaflet" || $FIELD_MODEL->get("name") eq "tag" || $FIELD_MODEL->get("name") eq "poster") && $RECORD_ID neq '' && $DRAFT_CAMPAIGNS eq '0' }
