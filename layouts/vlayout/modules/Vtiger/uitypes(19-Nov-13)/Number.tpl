...
{if $MODULE eq 'Campaigns' && ($FIELD_MODEL->get("name") eq "targetsize" || $FIELD_MODEL->get("name") eq "actualsalescount" || $FIELD_MODEL->get("name") eq "expectedsalescount" || $FIELD_MODEL->get("name") eq "expectedresponsecount") && $RECORD_ID neq '' && $DRAFT_CAMPAIGNS eq '0'}
