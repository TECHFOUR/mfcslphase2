...
{strip}
<script>
	var camptype = "{$camp_type}";
	function buttonShowHide(saveid) {
		$("#"+saveid).hide();
		$("#process_"+saveid).show();
	}
</script>
	...
	<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
		...
		{/if}
			<span class="pull-right">
            	{if $MODULE eq 'Events'}
                <p class="btn btn-success"  id="process_save_action_top" style="display:none;" ><strong>Processing...</strong></p>
                {/if}
				<button class="btn btn-success" type="submit" id="save_action_top" style="visibility:visible;" {if $MODULE eq 'Events'}onclick="buttonShowHide(this.id);"{/if}><strong>{vtranslate('LBL_SAVE', $MODULE)}</strong></button>                
