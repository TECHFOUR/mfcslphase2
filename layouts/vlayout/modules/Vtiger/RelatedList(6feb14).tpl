			...
			<div class="span8">
				...
				{foreach item=RELATED_LINK from=$RELATED_LIST_LINKS['LISTVIEWBASIC']}
					<div class="btn-group">
                        ...
                        {if $MODULE eq 'Leads' && $CUSTOMER_TYPE eq 'Individual'}
        
        				{else}
                         {*<!--Start code to hide Add Task Button in Lead related of Calendar by jitendra singh on 3 Feb 2014 -->*}
                        {if $RELATED_LINK->getLabel() eq 'Add Event'}
