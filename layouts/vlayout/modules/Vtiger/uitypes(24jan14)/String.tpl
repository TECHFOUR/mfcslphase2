...
{if $RECORD_FOR_DETAIL neq '' && ($MODULE eq 'Leads' && ($FIELD_MODEL->get("name") eq "state" || $FIELD_MODEL->get("name") eq "code"))}
...
data-fieldinfo='{$FIELD_INFO}' {if !empty($SPECIAL_VALIDATOR)}data-validator={Zend_Json::encode($SPECIAL_VALIDATOR)}{/if} readonly="readonly" />
