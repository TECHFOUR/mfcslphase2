...
<div class="popupEntriesDiv">
	...
	<table class="table table-bordered listViewEntriesTable">
		...
		<tr class="listViewEntries" data-id="{$LISTVIEW_ENTRY->getId()}" data-module="{$MODULE}" data-name='{$LISTVIEW_ENTRY->getName()}' data-info='{ZEND_JSON::encode($LISTVIEW_ENTRY->getRawData())}'
