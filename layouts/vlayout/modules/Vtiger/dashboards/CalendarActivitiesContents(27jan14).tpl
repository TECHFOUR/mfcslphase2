...
<div style='padding:5px'>
	...
	<div>
     ...
     {if $CURRENTUSERDEPTH eq 8} {* Start for Mo Only *}         
         <div>
            ...
            <div class='pull-left' style='margin-top:5px; ' >		
				&nbsp; &nbsp; {$ACTIVITY->get('d')} / {$ACTIVITY->get('dheld')}              
			</div>
            
            <div class='pull-left' style='margin-top:5px; margin-left:100px; ' >		
				&nbsp; &nbsp; {$ACTIVITY->get('dd')} / {$ACTIVITY->get('ddheld')}              
			</div>
            
             <div class='pull-right' style='margin-top:5px; ' >		
				&nbsp; &nbsp; {$ACTIVITY->get('ddd')} / {$ACTIVITY->get('dddheld')}              
			</div>
