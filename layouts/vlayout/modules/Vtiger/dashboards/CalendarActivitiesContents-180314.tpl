...
<div style='padding:5px'>
	...
	<div>
        ...
        {if $INDEX eq 0 && ($PROFILEID eq 2 ||  $PROFILEID eq 4 ||  $PROFILEID eq 7 ||  $PROFILEID eq 8 ||  $PROFILEID eq 9 ||  $PROFILEID eq 10 || $PROFILEID eq 11 || $PROFILEID eq 12 || $PROFILEID eq 13)}
                <div>
     ...
     {if $PROFILEID eq 2 ||  $PROFILEID eq 4 ||  $PROFILEID eq 7 ||  $PROFILEID eq 8 ||  $PROFILEID eq 9 ||  $PROFILEID eq 10 || $PROFILEID eq 11 || $PROFILEID eq 12 || $PROFILEID eq 13} {* Start for Mo Only *}         
         <div style="width:100%;">
			<div class='pull-left' style='margin-top:5px; font-size:9px;;width:30%'>				
