...
<div class="dashboardWidgetHeader">
	...
	<thead>
		<tr>
			...
			<th class="span2">
            {if $PROFILEID eq 1 || $PROFILEID eq 2 ||  $PROFILEID eq 4 ||  $PROFILEID eq 7 ||  $PROFILEID eq 8 ||  $PROFILEID eq 9 ||  $PROFILEID eq 10 || $PROFILEID eq 11 || $PROFILEID eq 12 || $PROFILEID eq 13}
				<div>
