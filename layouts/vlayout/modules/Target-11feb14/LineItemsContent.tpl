...
{strip}
   ...
   <i title="Select" class="icon-search relatedPopup" id="{$Targets_editView_fieldName_salesperson_select}"></i></span>
     ...
     <td>	
    <label class="muted pull-left marginRight5px"> <span class="redColor">*</span></label>
    <input id="{$target}" name="{$target}" type="text" placeholder="No of ROs" style="width:128px" title="No of ROs" class="qty smallInputBox" data-validation-engine="validate[ required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" onkeyup="ValidatePriceField(this.id);" />
		
	</td>
     <td>	
    <label class="muted pull-left marginRight5px"> <span class="redColor">*</span></label>
    <input id="{$revenue}" name="{$revenue}" type="text" placeholder="Revenue" style="width:128px" maxlength="10" title="Revenue" class="qty smallInputBox" data-validation-engine="validate[ required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" onkeyup="ValidatePriceField(this.id);" />
