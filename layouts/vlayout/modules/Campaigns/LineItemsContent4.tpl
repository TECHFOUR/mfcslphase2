...
{strip}
    ...
    <td id="{$row_11_other1}" style="visibility:visible;">
		...
		<span class="redColor">&nbsp;&nbsp;</span><textarea  id="{$other1}" name="{$other1}"  class="qty smallInputBox" placeholder="Other1" title="Other1" style="width:128px; height:40px;" /></textarea>
    ...
    <td id="{$row_12_other2}" style="visibility:visible;">
		...
		<span class="redColor">&nbsp;&nbsp;</span><textarea id="{$other2}"  name="{$other2}"  class="qty smallInputBox" placeholder="Other2" title="Other2" style="width:128px; height:40px;" /></textarea>
