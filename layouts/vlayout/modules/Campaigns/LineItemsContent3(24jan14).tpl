...
{strip}
    ...
    <td id="{$row_5_expectedsalescount}" style="visibility:visible;">
		 ...
		 <span class="redColor">&nbsp;&nbsp;</span><input  type="text" id="{$expectedsalescount}" name="{$expectedsalescount}"  class="qty smallInputBox"  placeholder="Target for Tagging" title="Target for Tagging" style="width:128px; height:18px;"/>
    ...
    <td id="{$row_6_expectedresponsecount}" style="visibility:visible;">
		 ...
		 <span class="redColor">&nbsp;&nbsp;</span><input id="{$expectedresponsecount}" name="{$expectedresponsecount}"  type="text" class="qty smallInputBox" placeholder="Target for Check Up" title="Target for Check Up" style="width:128px; height:18px;" />
    ...
    <td id="{$row_8_leaflet}" style="visibility:visible;">
		 ...
		 <span class="redColor">&nbsp;&nbsp;</span><input type="text"   id="{$leaflet}"  name="{$leaflet}"class="qty smallInputBox" placeholder="No.of Required Leaflet" title="No.of Required Leaflet" style="width:128px; height:18px;"/>
    ...
    <td id="{$row_9_poster}" style="visibility:visible;">
		 ...
		 <span class="redColor">&nbsp;&nbsp;</span><input type="text"   id="{$poster}" name="{$poster}" class="qty smallInputBox" placeholder="No.of Required Poster" title="No.of Required Poster" style="width:128px; height:18px;"/>
    ...
    <td id="{$row_10_tag}" style="visibility:visible;">
		 ...
		 <span class="redColor">&nbsp;&nbsp;</span><input type="text" id="{$tag}" name="{$tag}"  class="qty smallInputBox"  placeholder="No.of Required Tag"  title="No.of Required Tag" style="width:128px; height:18px;"/>
