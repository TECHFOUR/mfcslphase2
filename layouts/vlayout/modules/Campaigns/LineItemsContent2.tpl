...
{strip}
	...
	<td id="{$row_13_extra}">  </td> 
   	...
   	<td  id="{$row_16_targetaudience}" style="visibility:visible;">
		 ...
		 <span class="redColor">&nbsp;&nbsp;</span><input id="{$targetaudience}" name="{$targetaudience}" type="text" onkeyup="ValidatePriceField(this.id);" class="qty smallInputBox" placeholder="Distance from Outlet" title="Distance from Outlet" style="width:128px; height:18px;"/>
   ...
   <i title="Select" class="icon-search relatedPopup" id="{$Campaigns_editView_fieldName_campaigntype_select}"></i></span>
    ...
    <td id="{$row_2_sponsor}" style="visibility:visible;">
		 ...
		 <span class="redColor">&nbsp;&nbsp;</span><input   id="{$sponsor}" onkeyup="ValidatePriceField(this.id);" name="{$sponsor}" type="text" class="qty smallInputBox" placeholder="Potential" title="Potential" style="width:128px; height:18px;"/>
   ...
   <span class="redColor">*</span><input type="text" id="{$targetsize}" onkeyup="ValidatePriceField(this.id);" name="{$targetsize}"  class="qty smallInputBox" data-validation-engine="validate[ required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]"  placeholder="Budget Cost" title="Budget Cost" style="width:128px; height:18px;" />
    ...
    <td id="{$row_4_actualsalescount}" style="visibility:visible;">
		 ...
		 <span class="redColor">&nbsp;&nbsp;</span><input type="text" id="{$actualsalescount}" onkeyup="ValidatePriceField(this.id);"  name="{$actualsalescount}"  class="qty smallInputBox" placeholder="Vehicle Send to Hub"  title="Vehicle Send to Hub" style="width:128px; height:18px;" />
