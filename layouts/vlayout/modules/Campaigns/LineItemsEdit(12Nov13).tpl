...
{strip}
 ...
 {*<!-- Code modified by jitendra singh [TECHFOUR] -->*}
    ...
    <tr>
        ...
        <tr>
            <th colspan="3"><span class="">{vtranslate('Campaigns Details', $MODULE)}</span></th>
        ...
        <tr id="row0" class="hide lineItemCloneCopy">
            {include file="LineItemsContent4.tpl"|@vtemplate_path:'Campaigns' row_no=0 data=[]}
        </tr>
        ...
        {if count($RELATED_PRODUCTS) eq 0}
            ...
            <tr id="row1" class="lineItemRow">
             ...
             <tr id="row1" class="lineItemRow">
                {include file="LineItemsContent4.tpl"|@vtemplate_path:'Campaigns' row_no=1 data=[]}
