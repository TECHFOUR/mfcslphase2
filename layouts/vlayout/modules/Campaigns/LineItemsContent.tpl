...
{strip}
	...
	<td>
         ...
         <span class="redColor">*</span><input type="Text" id="{$end_date}" name="{$end_date}" maxlength="25" style="width:128px" size="25" onclick="javascript:NewCssCal(this.id)" data-validation-engine="validate[ required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]"  placeholder="End Date" title="End Date" />
	...
	<td>
         <span class="redColor">*</span><select id="{$start_time}" name="{$start_time}" ata-placeholder="Select Start Time"  style="width:138px;" title="Start Time" data-validation-engine="validate[ required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]">
	...
	<td>
         ...
         <span class="redColor">*</span><select id="{$end_time}" name="{$end_time}"  style="width:138px;" placeholder="Start Date" title="End Time" data-validation-engine="validate[ required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" >
