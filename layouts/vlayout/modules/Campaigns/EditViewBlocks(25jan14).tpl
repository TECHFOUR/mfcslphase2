	...
	<form class="form-horizontal recordEditView" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
		...
		{foreach key=BLOCK_LABEL item=BLOCK_FIELDS from=$RECORD_STRUCTURE name="EditViewBlockLevelLoop"}
			...
			{foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
               ...
               {if ($FIELD_MODEL->get('name') eq 'actualresponsecount'  || $FIELD_MODEL->get('name') eq 'actual_send_to_hub' || $FIELD_MODEL->get('name') eq 'actual_tagging' || $FIELD_MODEL->get('name') eq 'actual_checkup' || $FIELD_MODEL->get('name') eq 'outlet' || $FIELD_MODEL->get('name') eq 'draft_campaign' || $FIELD_MODEL->get('name') eq 'total_uploded_lead' || $FIELD_MODEL->get('name') eq 'total_rejected_lead' || $FIELD_MODEL->get('name') eq 'total_appointment_booked' || $FIELD_MODEL->get('name') eq 'total_lead_conversion' || $FIELD_MODEL->get('name') eq 'actual_leaflet' || $FIELD_MODEL->get('name') eq 'actual_poster' || $FIELD_MODEL->get('name') eq 'actual_tag' || $FIELD_MODEL->get('name') eq 'campaignname' || $FIELD_MODEL->get('name') eq 'campaignstatus' || $FIELD_MODEL->get('name') eq 'expectedresponse') && $RECORD_ID eq ''}  
