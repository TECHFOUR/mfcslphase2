...
{strip}
 ...
 {*<!-- Code modified by jitendra singh [TECHFOUR] -->*}
    <table class="table table-bordered blockContainer lineItemTable" id="lineItemTab">
        <tr>
            <th colspan="3"><span class="inventoryLineItemHeader">{vtranslate('Campaigns Details', $MODULE)}</span></th>
       ...
       <!-- <tr id="row0" class="hide lineItemCloneCopy">
            {include file="LineItemsContentLavel.tpl"|@vtemplate_path:'Campaigns' row_no=0 data=[]}
        </tr>-->
        ...
        <!--<tr id="row0" class="hide lineItemCloneCopy">
            {include file="LineItemsContentLavel2.tpl"|@vtemplate_path:'Campaigns' row_no=0 data=[]}
        </tr>-->
        
        <tr id="row0" class="hide lineItemCloneCopy">
            {include file="LineItemsContent2.tpl"|@vtemplate_path:'Campaigns' row_no=0 data=[]}
        </tr>
        <tr id="row0" class="hide lineItemCloneCopy">
            {include file="LineItemsContent3.tpl"|@vtemplate_path:'Campaigns' row_no=0 data=[]}
        </tr>
        
       
        
        {if count($RELATED_PRODUCTS) eq 0}
             <!--<tr id="row1" class="lineItemRow" style="border:#930">
                {include file="LineItemsContentLavel.tpl"|@vtemplate_path:'Campaigns' row_no=1 data=[]}
            </tr>--> 
            ...
            <tr id="row1" class="lineItemRow">
             ...
             <!--<tr id="row1" class="lineItemRow">
                {include file="LineItemsContentLavel2.tpl"|@vtemplate_path:'Campaigns' row_no=1 data=[]}
            </tr>-->
             <tr id="row1" class="lineItemRow">
                {include file="LineItemsContent2.tpl"|@vtemplate_path:'Campaigns' row_no=1 data=[]}
               
            </tr>  
             <tr id="row1" class="lineItemRow">
                {include file="LineItemsContent3.tpl"|@vtemplate_path:'Campaigns' row_no=1 data=[]}
