...
{strip}
	...
	<td>
 	...
 	<td>
          ...
          <input type="Text" id="{$start_date}" name="{$start_date}" maxlength="25" style="width:77px" size="25"  onclick="javascript:NewCssCal(this.id)" data-validation-engine="validate[ required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]"/>
	</td>
	<td>
		 <strong>End Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong> 
         <input type="Text" id="{$end_date}" name="{$end_date}" maxlength="25" style="width:77px" size="25" onclick="javascript:NewCssCal(this.id)" data-validation-engine="validate[ required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" />
		
	</td>
	<td>
		<strong>Start Time</strong>
        <select id="{$start_time}" name="{$start_time}"  style="width:90px;" >
	...
	<td>
        ...
        <select id="{$end_time}" name="{$end_time}"  style="width:90px;" >
                <option value='01:00'>01:00 AM</option>
                <option value='01:30'>01:30 AM</option>
                <option value='02:00'>02:00 AM</option>
                <option value='02:30'>02:30 AM</option>
	...
	<td>
	<strong>Location&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><input id="{$location}" name="{$location}" type="text" class="qty smallInputBox"  />
		
	</td>
    <td>
		<strong>Distance from Outlet</strong><input id="{$targetaudience}" name="{$targetaudience}" type="text" class="qty smallInputBox" />
