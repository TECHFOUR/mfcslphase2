...
class Services extends CRMEntity {
	...
	var $list_fields = Array(
		...
		'Model No'=>Array('service'=>'service_no'),
		'Make'=>Array('service'=>'make'),
		'Model'=>Array('service'=>'model'),        
		'Period in month'=>Array('service'=>'pmonth'),
		'Service due in how many Km'=>Array('service'=>'serviceduekm')
	);
	var $list_fields_name = Array(
		...
		'Make'=>'make',
		'Model'=>'model',		
		'Period in month'=>'pmonth',
		'Service due in how many Km'=>'serviceduekm'
	);

	// Make the field link to detail view
	var $list_link_field= 'model';
	...
	var $popup_fields = Array ('model');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'model';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'model';

	// Required Information for enabling Import feature
	var $required_fields = Array('model'=>1);

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('model', 'assigned_user_id');

	var $default_order_by = 'model';
