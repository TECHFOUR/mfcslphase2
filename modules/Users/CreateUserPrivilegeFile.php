...
//Constructing Calendar Sharing Rules Added by Ajay [TECHFOUR]
			$calendar_share_per_array=getUserModuleSharingObjects("Calendar",$userid,$def_org_share,$current_user_roles,$parent_roles,$current_user_groups);
			$calendar_share_read_per=$calendar_share_per_array['read'];
			$calendar_share_write_per=$calendar_share_per_array['write'];
			$newbuf .= "\$Calendar_share_read_permission=array('ROLE'=>".constructTwoDimensionalCharIntSingleValueArray($calendar_share_read_per['ROLE']).",'GROUP'=>".constructTwoDimensionalValueArray($calendar_share_read_per['GROUP']).");\n\n";	
