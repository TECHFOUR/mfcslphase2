...
class DriverMaster extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_drivermaster';
    var $table_index= 'drivermasterid';
     ...
     */
    var $customFieldTable = Array('vtiger_drivermastercf', 'drivermasterid');

    /**
     * Mandatory for Saving, Include tables related to this module.
     */
    var $tab_name = Array('vtiger_crmentity', 'vtiger_drivermaster', 'vtiger_drivermastercf');
    ...
    var $tab_name_index = Array(
		...
		'vtiger_drivermaster'   => 'drivermasterid',
	    'vtiger_drivermastercf' => 'drivermasterid');
    ...
    // tablename should not have prefix 'vtiger_'									
		...
		'Driver Name'=>Array('drivermaster','drivermaster'),
		'Driver Id'=>Array('drivermaster','cf_889'),
		'Mobile No'=>Array('drivermaster','cf_891'),
		'Status'=>Array('drivermaster','cf_893'),			
		'Assigned To'=>Array('crmentity'=>'smownerid')
    );
    var $list_fields_name = Array(
    /* Format: Field Label => fieldname */		
		
		'Driver Name'=>'drivermaster',
		'Driver Id'=>'cf_889',
		'Mobile No'=>'cf_891',
		'Status'=>'cf_893',			
	...
	var $list_link_field = 'drivermaster';
	...
	var $popup_fields = Array('cf_889');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'cf_889';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'cf_889';

	// Required Information for enabling Import feature
	var $required_fields = Array('cf_889'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'cf_889';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'cf_889');
