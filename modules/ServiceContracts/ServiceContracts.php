...
class ServiceContracts extends CRMEntity {
	...
	var $list_fields = Array (
		...
		'First Name' => Array('servicecontracts', 'subject'),
		'Last Name' => Array('servicecontracts','last_name'),
		'Assigned To' => Array('crmentity','smownerid'),				
		'Mobile No' => Array('servicecontracts','mobile'),
		'Status' => Array('servicecontracts','contract_status'),
		'Man Power No' => Array('servicecontracts','contract_no')
	);
