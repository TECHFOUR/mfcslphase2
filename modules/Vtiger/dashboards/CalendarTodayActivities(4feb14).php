...
Class Vtiger_CalendarTodayActivities_Dashboard extends Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$dayless1day = date('m/d/y',strtotime('- 1 days', strtotime($currentDate)));			
		$daygreater1day = date('m/d/y',strtotime('+ 1 days', strtotime($currentDate)));	
		$daygreater2day = date('m/d/y',strtotime('+ 2 days', strtotime($currentDate)));
