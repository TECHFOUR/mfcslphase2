...
class Activity extends CRMEntity {
	...
	{		
		...
		$lead_details = array();
			...
			$lead_details[0]['setype'] = 'AJAy';
			$lead_details[0]['setype1'] = 'Vijay';	
			$lead_details[1]['setype'] = 'Kumar';
			$lead_details[1]['setype1'] = 'Kumar';
...
// End Auto Lead activity [TECHFOUR]  **********************				
	...
	function getLeadDetails($parent_id) {		
		...
		$query = "  INNER JOIN vtiger_crmentity ON vtiger_crmentity.crmid = vtiger_leadscf.leadid
					...
					WHERE vtiger_crmentity.setype = ? AND vtiger_crmentity.deleted = 0 AND (registrationno = ?  AND mobile = ?) ";
