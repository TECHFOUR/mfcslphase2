...
class Calendar_Detail_View extends Vtiger_Detail_View {
	...
	function preProcess(Vtiger_Request $request, $display=true) {
		...
		/*Start code to find the Activity Status of Current Activity by jitendra singh on 15 feb 2014*/
		
		$activity_query = $adb->query("select  eventstatus from vtiger_activity 						                       
						...
						if($adb->num_rows($activity_query) > 0) {
							...
							$activity_status = $activitydata['eventstatus'];
						}
		/*Start code to find the Activity Status of Current Activity by jitendra singh on 15 feb 2014*/
		...
		$viewer->assign('ACTIVITY_STATUS', $activity_status); // Assign value of Activity Status for edit button , If Held then Edit button will not shown by jitendra singh
