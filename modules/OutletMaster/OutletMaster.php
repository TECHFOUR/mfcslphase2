...
class OutletMaster extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_outletmaster';
    var $table_index= 'outletmasterid';
     ...
     */
    var $customFieldTable = Array('vtiger_outletmastercf', 'outletmasterid');

    /**
     * Mandatory for Saving, Include tables related to this module.
     */
    var $tab_name = Array('vtiger_crmentity', 'vtiger_outletmaster', 'vtiger_outletmastercf');
    ...
    var $tab_name_index = Array(
		...
		'vtiger_outletmaster'   => 'outletmasterid',
	    'vtiger_outletmastercf' => 'outletmasterid');
    ...
    // tablename should not have prefix 'vtiger_'
		'Plant Code'=> Array('outletmaster', 'outletmaster'),		
		'Outlet'=>Array('outletmastercf','outlet'),
		'Zone'=> Array('outletmastercf', 'cf_781'),
		'State'=>Array('outletmastercf','state'),
		'Assigned To' => Array('crmentity','smownerid')
    );
    var $list_fields_name = Array(
    /* Format: Field Label => fieldname */
		'Plant Code'=> 'projectname',
		'Outlet'=> 'outlet',
		'Zone'=>'cf_781',
		'State'=>'state',
	...
	var $list_link_field = 'outletmaster';
	...
	var $popup_fields = Array('outletmaster');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'outletmaster';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'outletmaster';

	// Required Information for enabling Import feature
	var $required_fields = Array('outletmaster'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'outletmaster';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'outletmaster');
