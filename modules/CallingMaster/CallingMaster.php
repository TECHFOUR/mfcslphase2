...
class CallingMaster extends CRMEntity {
    var $db, $log; // Used in class functions of CRMEntity

    var $table_name = 'vtiger_callingmaster';
    var $table_index= 'callingmasterid';
     ...
     */
    var $customFieldTable = Array('vtiger_callingmastercf', 'callingmasterid');

    /**
     * Mandatory for Saving, Include tables related to this module.
     */
    var $tab_name = Array('vtiger_crmentity', 'vtiger_callingmaster', 'vtiger_callingmastercf');
    ...
    var $tab_name_index = Array(
		...
		'vtiger_callingmaster'   => 'callingmasterid',
	    'vtiger_callingmastercf' => 'callingmasterid');
    ...
    // tablename should not have prefix 'vtiger_'									
		'callingmaster'=>Array('callingmaster','callingmaster'),
		/*'Driver Name'=>Array('drivercf','cf_877'),
		'Mobile No'=>Array('drivercf','cf_879'),
		'Pickup Date'=>Array('drivercf','cf_881'),*/			
		'Assigned To' => Array('crmentity','smownerid')
    );
    var $list_fields_name = Array(
    /* Format: Field Label => fieldname */		
		'callingmaster'=> 'callingmaster',
		/*'Driver Name'=>'cf_877',
		'Mobile No'=>'cf_879',
		'Pickup Date'=>'cf_881',*/		
	...
	var $popup_fields = Array('callingmaster');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'callingmaster';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'callingmaster';

	// Required Information for enabling Import feature
	var $required_fields = Array('callingmaster'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'callingmaster';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'callingmaster');
